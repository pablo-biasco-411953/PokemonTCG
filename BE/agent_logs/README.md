# Registro de Tareas del Agente (Backend)

Esta carpeta se utiliza para que todos los agentes de IA que trabajen en el **Backend (BE)** registren su progreso, los cambios realizados y cualquier tarea que haya quedado pendiente o a medio camino.
...
Crea un archivo llamado `task-[nombre-de-la-tarea].md` (ej: `task-fix-bot-strategy.md`) con la siguiente estructura:
