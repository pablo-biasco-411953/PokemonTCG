...
1. **Bot jugando Entrenadores:** Solucionado en el backend restringiendo `esPokemonBasico` en `EstrategiaBasica.java`.
...
## Próximos pasos
- Validar visualmente en la interfaz que al pasar el mouse sobre un Trainer se muestre su descripción completa en partida.
